...
<img src="https://img.shields.io/badge/Version(INSCameraSDK)-2.7.33-blue"></img>
<img src="https://img.shields.io/badge/Version(INSCoreMedia)-1.25.20-blue"></img>
...
```ogdl
binary "#INSCoreMedia:By applying for authorization from Insta360#" == 1.25.20
binary "#INSCameraSDK-osc:By applying for authorization from Insta360#" == 2.7.33
```
